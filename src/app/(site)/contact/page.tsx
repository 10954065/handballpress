...
export default async function ContactPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-14 sm:px-6">
      <p className="text-gold-dark text-xs font-bold tracking-[0.16em] uppercase">Contact</p>
      ...
      <a
        ...
        className="bg-navy hover:bg-blue-dark mt-8 inline-block rounded-sm px-6 py-3 text-sm font-semibold text-white transition-colors"
      >
        {CONTACT_EMAIL}
      </a>
